...
#
# Created: Fri Mar 15 02:26:31 2013
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.phonemesGroup = QtGui.QGroupBox(self.frame)
        self.phonemesGroup.setGeometry(QtCore.QRect(10, 10, 581, 551))
        self.phonemesGroup.setObjectName(_fromUtf8("phonemesGroup"))
        self.listPhonemes = QtGui.QListWidget(self.phonemesGroup)
        self.listPhonemes.setGeometry(QtCore.QRect(10, 280, 256, 211))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        item = QtGui.QListWidgetItem()
        self.listPhonemes.addItem(item)
        self.btnAddPhoneme = QtGui.QPushButton(self.phonemesGroup)
        self.btnAddPhoneme.setEnabled(False)
        self.btnAddPhoneme.setGeometry(QtCore.QRect(190, 240, 31, 31))
        ...
        self.btnRemovePhoneme = QtGui.QPushButton(self.phonemesGroup)
        self.btnRemovePhoneme.setEnabled(False)
        self.btnRemovePhoneme.setGeometry(QtCore.QRect(230, 240, 31, 31))
        ...
        self.imgPhoneme = QtGui.QLabel(self.phonemesGroup)
        ...
        self.lblImagePath = QtGui.QLabel(self.phonemesGroup)
        self.lblImagePath.setGeometry(QtCore.QRect(10, 190, 261, 31))
        font = QtGui.QFont()
        ...
        self.btnLoadImage = QtGui.QPushButton(self.phonemesGroup)
        self.btnLoadImage.setEnabled(False)
        self.btnLoadImage.setGeometry(QtCore.QRect(170, 90, 101, 31))
        self.btnLoadImage.setObjectName(_fromUtf8("btnLoadImage"))
        self.txtNewPhoneme = QtGui.QLineEdit(self.phonemesGroup)
        self.txtNewPhoneme.setGeometry(QtCore.QRect(10, 240, 171, 27))
        self.txtNewPhoneme.setObjectName(_fromUtf8("txtNewPhoneme"))
        self.btnMakeGoal = QtGui.QPushButton(self.phonemesGroup)
        self.btnMakeGoal.setEnabled(False)
        self.btnMakeGoal.setGeometry(QtCore.QRect(60, 500, 151, 31))
        self.btnMakeGoal.setObjectName(_fromUtf8("btnMakeGoal"))
        self.goalsGroup = QtGui.QGroupBox(self.phonemesGroup)
        self.goalsGroup.setGeometry(QtCore.QRect(280, 270, 291, 271))
        self.goalsGroup.setObjectName(_fromUtf8("goalsGroup"))
        self.listGoals = QtGui.QListWidget(self.goalsGroup)
        self.listGoals.setGeometry(QtCore.QRect(10, 30, 271, 191))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.listGoals.setFont(font)
        self.listGoals.setAlternatingRowColors(True)
        self.listGoals.setViewMode(QtGui.QListView.ListMode)
        self.listGoals.setObjectName(_fromUtf8("listGoals"))
        self.btnRemoveGoal = QtGui.QPushButton(self.goalsGroup)
        self.btnRemoveGoal.setEnabled(False)
        self.btnRemoveGoal.setGeometry(QtCore.QRect(70, 230, 151, 31))
        self.btnRemoveGoal.setObjectName(_fromUtf8("btnRemoveGoal"))
        self.soundsGroup = QtGui.QGroupBox(self.phonemesGroup)
        self.soundsGroup.setEnabled(False)
        self.soundsGroup.setGeometry(QtCore.QRect(280, 20, 291, 251))
        ...
        self.btnE_acute.setGeometry(QtCore.QRect(130, 30, 31, 27))
        ...
        self.btnE.setGeometry(QtCore.QRect(160, 30, 31, 27))
        ...
        self.btnI.setGeometry(QtCore.QRect(190, 30, 31, 27))
        ...
        self.btnOU.setGeometry(QtCore.QRect(250, 30, 31, 27))
        ...
        self.btnAN.setGeometry(QtCore.QRect(30, 70, 31, 27))
        ...
        self.btnON.setGeometry(QtCore.QRect(60, 70, 31, 27))
        ...
        self.btnUN.setGeometry(QtCore.QRect(90, 70, 31, 27))
        ...
        self.btnIN.setGeometry(QtCore.QRect(120, 70, 31, 27))
        ...
        self.btnUI.setGeometry(QtCore.QRect(150, 70, 31, 27))
        ...
        self.btnOI.setGeometry(QtCore.QRect(220, 70, 41, 27))
        ...
        self.btnP.setGeometry(QtCore.QRect(50, 120, 31, 27))
        ...
        self.btnB.setGeometry(QtCore.QRect(80, 120, 31, 27))
        ...
        self.btnF.setGeometry(QtCore.QRect(110, 120, 31, 27))
        ...
        self.btnV.setGeometry(QtCore.QRect(150, 120, 31, 27))
        ...
        self.btnM.setGeometry(QtCore.QRect(180, 120, 31, 27))
        ...
        self.btnR.setGeometry(QtCore.QRect(210, 120, 31, 27))
        ...
        self.btnT.setGeometry(QtCore.QRect(50, 160, 31, 27))
        ...
        self.btnD.setGeometry(QtCore.QRect(80, 160, 31, 27))
        ...
        self.btnS.setGeometry(QtCore.QRect(110, 160, 31, 27))
        ...
        self.btnZ.setGeometry(QtCore.QRect(150, 160, 31, 27))
        ...
        self.btnN.setGeometry(QtCore.QRect(180, 160, 31, 27))
        ...
        self.btnL.setGeometry(QtCore.QRect(210, 160, 31, 27))
        ...
        self.btnK.setGeometry(QtCore.QRect(70, 200, 31, 27))
        ...
        self.btnG.setGeometry(QtCore.QRect(100, 200, 31, 27))
        ...
        self.btnCH.setGeometry(QtCore.QRect(130, 200, 31, 27))
        ...
        self.btnJ.setGeometry(QtCore.QRect(160, 200, 31, 27))
        ...
        self.btnGN.setGeometry(QtCore.QRect(190, 200, 31, 27))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.phonemesGroup.setTitle(_translate("mainWindow", "Phoneme Settings", None))
        ...
        self.btnMakeGoal.setText(_translate("mainWindow", "Make Goal", None))
        self.goalsGroup.setTitle(_translate("mainWindow", "Goals", None))
        self.btnRemoveGoal.setText(_translate("mainWindow", "Remove Goal", None))
